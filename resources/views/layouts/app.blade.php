    ...
    <body class="bg-gray-100">
        ...
        <div class="container px-24 mt-8 mx-auto">
            <header class="flex items-center mb-12">
                ...
                <a href="{{ route('pictures.create') }}" class="ml-auto bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded"> <!-- @Piotr -  a link to route pictures/create, translated to http://localhost:8000/pictures/create, I think pictures.create method/function is invoked (file PictureController.php) and returns/renders view('upload') --> 
                    Add your own dog
                </a>
            </header>
